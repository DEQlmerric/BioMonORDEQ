...
gis.screens <- read.xlsx('Reference/ref_screen.DEQ.xlsx', sheet = 'ref_screen.DEQ 2023-11-17')


####### bring in Google Earth screens outputs
### DEQ
ge.screens <- read.xlsx('Reference/GE_Site_sum.scores_ave_bpj.xlsx', sheet = 'GE_final.bpj_ 2023-11-17')
...
write.csv(one.table_new, 'Reference/one.table_rule.all.csv')

...
tss.r <- tss.sc %>% select(Result_Numeric_mod, COMID)
tss.r <- subset(tss.r, tss.r$COMID != '23774647' & tss.r$COMID != '23877125' & tss.r$COMID != '23810652' & tss.r$COMID != '23764745')


tss.sc <- left_join(tss.r, scmets, by = "COMID") #merge TSS AWQMS data pull with desired StreamCat metrics

r <- randomForest(y = tss.sc$Result_Numeric_mod, x = tss.sc[3:81], importance = TRUE,  keep.forest = TRUE)

sapply(tss.sc, function(x) sum(is.na(x))) #find out which columns have NAs
...
print(r)
>>>>>>> 9375d54e8534673bb2ec383cadc4be6a58a3efbe
```

...
tss <- read_excel("TSS_2025-11-12.xlsx") #output file from ref benchmarks script - Ambient sites included
...
pred.rf <- predict(rf.full, newdata = tss.cal)
plot(log(pred.rf+1) ~ log(tss.cal$TSS+1), xlab = "log Observed TSS", ylab = "log Predicted TSS")
abline(a=0,b=1)

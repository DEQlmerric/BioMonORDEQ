...
#### View recent StreamCat updates: <https://www.epa.gov/national-aquatic-resource-surveys/streamcat-updates>
...
# EXPLORE VARIANCE FOR EACH METRIC TO GUIDE WHICH TO KEEP <----- DELETE WHEN DONE
...
rm(list=c('ag2','clim2','cover2','dams2','fire2','flow2','iwi2','litho2','mintox2','other2','roads2','urb2','meow2'))
```
...
library(rpart)
mod <- rpart(Result_Numeric_mod ~ ., data = tss.cal.test)
plot(mod)
text(mod, use.n = TRUE)

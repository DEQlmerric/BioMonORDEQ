...
#Untransformed plot no log scale axes
plot(exp(tss.cal$logTSS) ~ exp(pred.rf.red_9), log = 'xy', xlab = 'predicted TSS (mg/L)', ylab = 'observed TSS (mg/L)', main = 'CAL Reduced Model Top 9 log scale axes')
abline(a=0,b=1)
...
text(1.2,3.3, paste0("Variance explained = ",rf.red_9_pct.var_val,"%"))
...
text(10,70, paste0("Variance explained = ",rf.red_9_pct.var_val,"%"))

#Untransformed plot no log scale axes
plot(exp(tss.val$logTSS) ~ exp(pred.rf.red_9_val), log = 'xy', xlab = 'predicted TSS (mg/L)', ylab = 'observed TSS (mg/L)', main = 'VAL Reduced Model Top 9 log scale axes')
abline(a=0,b=1)

...
```{r}
cond <- read_excel('~/BioMonORDEQ/Benchmarks/Water Chemistry/Conductivity/Conductivity_no_outliers_2026-01-21.xlsx') #output file from ref benchmarks script - Ambient sites included
...
sapply(cond_vars, function(x) sum(is.na(x)))
...
varImpPlot(rf.full, type = 1, n.var = 25, main = "Conductivity All-Sites Full Model") #variable importance plot
```

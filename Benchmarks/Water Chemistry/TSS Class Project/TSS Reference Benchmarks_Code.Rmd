...
# REF-ONLY PREDICTION PLOT/EXPECTATIONS ---------------------------------------------------------------------------------------------------------------------------
...
plot((exp(tss.cal_val.refadj$logTSS)-1) ~ (exp(pred.rf.red_15.all)-1), log = "xy", xlab = 'predicted TSS (mg/L)', ylab = 'observed TSS (mg/L)', ylim = c(0.2,100), xlim = c(0.2,100), main = '')
#fix scales and logs
# must run bottom section of code before this
```

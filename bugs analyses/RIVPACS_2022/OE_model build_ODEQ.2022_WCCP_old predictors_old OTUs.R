...
#detach("package:NAMCr", unload = TRUE)
     save(bugcal.pa, predcal, grps.final, preds.final, rf.250ct_7grps, file=('bugs analyses/RIVPACS_2022/WCCP_rf.mod_05preds_200.Rdata')); # Notice I'm using the most parsimonious model (with 8 predictors)
...
load("bugs analyses/RIVPACS_2022/WCCP_rf.mod_05preds_200.Rdata")

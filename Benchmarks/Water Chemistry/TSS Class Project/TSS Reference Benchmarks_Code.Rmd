...
```{r}
tss <- read_excel("TSS_10292025.xlsx") #output file from ref benchmarks script
...
rm(list = c('nomatch', 'nomatch.c')) #clean up environment
...
spear2 <- spear.rows %>% mutate(new_column = ifelse(rowname > 40, "High Pages", "Low Pages"))

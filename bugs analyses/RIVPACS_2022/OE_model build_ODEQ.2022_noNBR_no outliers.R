...
rfdat<-data.frame(predcal,Groups=grps.6);
#windows()
...
rfdat<-data.frame(predcal,grps.5, grps.6, grps.7, grps.8, grps.9, grps.10, grps.11);
...
rfdat <- rfdat %>%
  dplyr::select(Tmean8110Ws,Precip8110Ws,CaOWs,SLOPE,WsAreaSqKm,perStrm,SiO2Ws,PermWs,
         Fe2O3Ws,ElevCat,Eco2,Eco3,Eco4_code,East.West, Lab,grps.5, grps.6, grps.7,grps.8,grps.9,grps.10,grps.11)
...
rf.250ct_6grps = randomForest(grps.6 ~ Tmean8110Ws+Precip8110Ws+CaOWs+SLOPE+WsAreaSqKm+perStrm+SiO2Ws+PermWs+Fe2O3Ws+ElevCat+Eco2+Eco3+Eco4_code+East.West, #,
                              data=rfdat, ntree=2000, importance=TRUE, norm.votes=TRUE, keep.forest=TRUE)
...
print(rf.250ct_11grps)

# Variable Importance Plot (VIP):
varImpPlot(rf.250ct_5grps, type=1,n.var=14);
varImpPlot(rf.250ct_6grps, type=1,n.var=14);
varImpPlot(rf.250ct_7grps, type=1,n.var=14);
varImpPlot(rf.250ct_8grps, type=1,n.var=14);
varImpPlot(rf.250ct_9grps, type=1,n.var=14);
varImpPlot(rf.250ct_10grps, type=1,n.var=14);
varImpPlot(rf.250ct_11grps, type=1,n.var=14);
...
# 4.3) Specify the final predictor variables ;Tmean8110Ws+Precip8110Ws+WsAreaSqKm+SiO2Ws+Fe2O3Ws+ElevCat+Eco3
      preds.final=c('Tmean8110Ws','Precip8110Ws','CaOWs','SLOPE','WsAreaSqKm','perStrm','SiO2Ws','PermWs','Fe2O3Ws','ElevCat','Eco2','Eco3', 'Eco4_code', 'East.West' ) # ,'Eco2','Eco3','Eco4_code','East.West'
...
#detach("package:NAMCr", unload = TRUE)
     save(bugcal.pa, predcal, grps.final, preds.final, rf.250ct_9grps, file=('bugs analyses/RIVPACS_2022/rf.mod.pca_250_noNBR.noOut.Rdata')); # Notice I'm using the most parsimonious model (with 8 predictors)
...
load("bugs analyses/RIVPACS_2022/rf.mod.pca_250_noNBR.noOut.Rdata")
...
OE.assess.cal<-model.predict.RanFor.4.2(bugcal.pa,grps.final,preds.final, ranfor.mod=rf.250ct_9grps,prednew=predcal,bugnew=bugcal.pa,Pc=0.5, Cal.OOB=TRUE); 

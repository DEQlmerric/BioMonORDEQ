...
hist(tss.cal$logTSS, main = "", xlab = "log TSS", col = "lightblue", ylim = c(0,300)) #log-transformed
hist(tss.val$logTSS, main = "", xlab = "log TSS", col = "lightgreen", add = TRUE)
     legend("topright", legend = c("CAL", "VAL"), fill = c("lightblue", "lightgreen")) #log-transformed
...
hist(scmets$POPDEN2010WS, main = "", xlab = "Population Density")
hist(scmets$PRECIP9120WS, main = "", xlab = "Precip, 1991-2020")
hist(scmets$PCTAGSLPMID2001WS, main = "", xlab = "Pct Ag Slopes >10%")


# KERNEL DENSITY PLOTS
kern <- scmets %>%
  select(WDRW_LDWS, PCTCONIF2001WS, CLAYWS, PESTIC1997WS, SANDWS, PCTCROP2001WS, POPDEN2010WS, PRECIP9120WS, PCTAGSLPMID2001WS)
...
plot(tss.cal$logTSS ~ pred.rf, xlab = 'predicted logTSS', ylab = 'observed logTSS', xlim = c(0,4.5),ylim = c(0,4.5), main = 'rf.full')
abline(a=0,b=1)
(rmse<-sqrt(sum((pred.rf - tss.cal$logTSS)^2)/length(tss.cal$logTSS))) #prediction error
...
abline(a=0,b=1)
(rmse<-sqrt(sum((pred.rf.red_20 - tss.cal$logTSS)^2)/length(tss.cal$logTSS))) #prediction error
print(paste("inverse natural log RMSE =", exp(rmse)-1))
```
...
abline(a=0,b=1)
(rmse<-sqrt(sum((pred.rf.red_15 - tss.cal$logTSS)^2)/length(tss.cal$logTSS))) #prediction error
print(paste("inverse natural log RMSE =", exp(rmse)-1))

#Untransformed plot log scale axes
plot((exp(tss.cal$logTSS)-1) ~ (exp(pred.rf.red_15)-1), log = "xy",  xlab = 'predicted TSS (mg/L)', ylab = 'observed TSS (mg/L)', main = 'red_15')
abline(a=0,b=1)
...
abline(a=0,b=1)
(rmse<-sqrt(sum((pred.rf.red_15_val - tss.cal$logTSS)^2)/length(tss.val$logTSS))) #prediction error
print(paste("inverse natural log RMSE =", exp(rmse)-1))

#Untransformed plot log scale axes
plot((exp(tss.val$logTSS)-1) ~ (exp(pred.rf.red_15_val)-1), log = "xy",  xlab = 'predicted TSS (mg/L)', ylab = 'observed TSS (mg/L)', main = 'red_15 VAL')
abline(a=0,b=1)
...
abline(a=0,b=1)
(rmse<-sqrt(sum((pred.rf.red_15_all - tss.cal_val$logTSS)^2)/length(tss.cal_val$logTSS))) #prediction error
print(paste("inverse natural log RMSE =", exp(rmse)-1))
```
...
abline(a=0,b=1)
(rmse<-sqrt(sum((pred.rf.red_4 - tss.cal$logTSS)^2)/length(tss.cal$logTSS))) #prediction error
print(paste("inverse natural log RMSE =", exp(rmse)-1))
```
...
(rmse<-sqrt(sum((pred.rf.red_15.all - tss.cal_val.refadj$logTSS)^2)/length(tss.cal_val.refadj$logTSS))) #prediction error
print(paste("inverse natural log RMSE =", exp(rmse)-1))
```
...
abline(a=0,b=1)
(rmse<-sqrt(sum((pred.rf.full.ref - tss.ref$logTSS)^2)/length(tss.ref$logTSS))) #prediction error
print(paste("inverse natural log RMSE =", exp(rmse)-1))
```
...
abline(a=0,b=1)
(rmse<-sqrt(sum((pred.rf.ref.red_20 - tss.ref$logTSS)^2)/length(tss.ref$logTSS))) #prediction error
print(paste("inverse natural log RMSE =", exp(rmse)-1))
```
...
abline(a=0,b=1)
(rmse<-sqrt(sum((pred.rf.ref.red_11 - tss.ref$logTSS)^2)/length(tss.ref$logTSS))) #prediction error
print(paste("inverse natural log RMSE =", exp(rmse)-1))
```
...
abline(a=0,b=1)
(rmse<-sqrt(sum((pred.rf.ref.red_5 - tss.ref$logTSS)^2)/length(tss.ref$logTSS))) #prediction error
print(paste("inverse natural log RMSE =", exp(rmse)-1))
...
pred.rf.ref.red_11<- predict(rf.ref.red_11, tss.cal_val.immutable) #model prediction on cal+val dataset
plot(tss.cal_val.immutable$logTSS ~ pred.rf.ref.red_11, xlab = 'predicted logTSS', ylab = 'observed logTSS', ylim = c(0,6), main = 'ref.red_11 CAL and VAL')

(rmse<-sqrt(sum((pred.rf.ref.red_11 - tss.cal_val.refadj$logTSS)^2)/length(tss.cal_val.refadj$logTSS))) #prediction error
print(paste("inverse natural log RMSE =", exp(rmse)-1))
```

...
```{r}
# SUBSET DATA
cond.src <- cond_vars_selected %>%  #subset CALibration dataset
...
#### Trying to reduce all human-influenced variables to 0, seeing what impact that has on the residuals

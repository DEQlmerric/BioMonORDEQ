...
par(mfrow=c(1,2))
partialPlot(rf.full, as.data.frame(tss.cal_val), WDRW_LDWS, main = '', ylab = "Predicted TSS")
...
# Want to scale back to 0.
par(mfrow=c(1,2))
partialPlot(rf.full, as.data.frame(tss.cal_val), PESTIC1997WS, main = '', ylab = "Predicted TSS")
...
# Want to scale back to 0.
par(mfrow=c(1,2))
partialPlot(rf.full, as.data.frame(tss.cal_val), PCTCROP2001WS, main = '', ylab = "Predicted TSS")
...
# Want to scale back to ~4.
par(mfrow=c(1,2))
partialPlot(rf.full, as.data.frame(tss.cal_val), POPDEN2010WS, main = '', ylab = "Predicted TSS")
...
# Want to scale back to zero.
par(mfrow=c(1,2))
partialPlot(rf.full, as.data.frame(tss.cal_val), PCTAGSLPMID2001WS, main = '', ylab = "Predicted TSS")
...
# Want to keep left 3 bars of histogram.
par(mfrow=c(1,2))
partialPlot(rf.full, as.data.frame(tss.cal_val), SW_FLUXWS, main = '', ylab = "Predicted TSS")
...
# 90th percentile?
par(mfrow=c(1,2))
partialPlot(rf.full, as.data.frame(tss.cal_val), PCTIMP2001WS, main = '', ylab = "Predicted TSS")
...
# Want to scale back to 0.
par(mfrow=c(1,2))
partialPlot(rf.full, as.data.frame(tss.cal_val), RDCRSWS, main = '', ylab = "Predicted TSS")

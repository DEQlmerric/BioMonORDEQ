...
=======
```{r, warning=FALSE}
>>>>>>> 1e20f5f10168f21725741d15cb98f4e65ee16ddc
...
write_xlsx(matrix, path = "C:/Users/athomps/Oregon/DEQ - Biomonitoring is Fun! - General/Env't Stats Class Project 2025/StreamCat/Spearmans2.xlsx")
```
...
```{r}
#++++++++++++++++++++++++placeholder for final metrics function+++++++++++++++++++++++
```
